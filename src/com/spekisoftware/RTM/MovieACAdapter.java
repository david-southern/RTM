/*
 * Copied out of the Android source so that I can make an adapter that always presents the current
 * contents of the array as the filtered view
 */
 ...
 * you want.
 */
public class MovieACAdapter<T> extends BaseAdapter implements Filterable
{
    /**
     * Contains the list of objects that represent the data of this MovieACAdapter. The content of this list is referred
     ...
     */
    public MovieACAdapter(Context context, int textViewResourceId)
    {
     ...
     */
    public MovieACAdapter(Context context, int resource, int textViewResourceId)
    {
     ...
     */
    public MovieACAdapter(Context context, int textViewResourceId, T[] objects)
    {
     ...
     *            The objects to represent in the ListView.
     */
    public MovieACAdapter(Context context, int resource, int textViewResourceId, T[] objects)
    {
     ...
     *            The objects to represent in the ListView.
     */
    public MovieACAdapter(Context context, int textViewResourceId, List<T> objects)
    {
     ...
     *            The objects to represent in the ListView.
     */
    public MovieACAdapter(Context context, int resource, int textViewResourceId, List<T> objects)
    {
    ...
    private View createViewFromResource(int position, View convertView, ViewGroup parent, int resource)
    {
        ...
        {
            Logger.Log(Logger.LOG_LEVEL_ERROR, "MovieACAdapter", "You must supply a resource ID for a TextView");
            throw new IllegalStateException("MovieACAdapter requires the resource ID to be a TextView", e);
        }
    ...
    /**
     * Creates a new MovieACAdapter from external resources. The content of the array is obtained through
     ...
     * 
     * @return An MovieACAdapter<CharSequence>.
     */
    public static MovieACAdapter<CharSequence> createFromResource(Context context, int textArrayResId, int textViewResId)
    {
        CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new MovieACAdapter<CharSequence>(context, textViewResId, strings);
    }
